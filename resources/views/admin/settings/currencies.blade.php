                ...
                <div class="modal-body p-24">
                    <form action="#">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label for="code" class="form-label fw-semibold text-primary-light text-sm mb-8">Code
                                </label>
                            ...
                            <div class="col-6">
                                <label for="currency" class="form-label fw-semibold text-primary-light text-sm mb-8">Is
            ...
            <div class="modal-content radius-16 bg-base">
                ...
                <div class="modal-body p-24">
                    <form action="#">
                        <div class="row">
                            <div class="col-6 mb-20">
                                <label for="editname" class="form-label fw-semibold text-primary-light text-sm mb-8">Name
                                </label>
                            ...
                            <div class="col-6">
                                <label for="editcode" class="form-label fw-semibold text-primary-light text-sm mb-8">Code
                                </label>
                            ...
                            <div class="col-6">
                                <label for="editcurrency"
                                    class="form-label fw-semibold text-primary-light text-sm mb-8">Is Cryptocurrency
                                </label>
