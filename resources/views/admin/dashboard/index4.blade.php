                                    ...
                                    <div class="p-20 h-240-px radius-8 overflow-hidden position-relative z-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                ...
                                                <img src="{{ asset('assets/images/card/card-logo.png') }}"
                                                    alt="">
                                            </div>

                                            <div>
                                                <span class="text-white text-xs fw-normal text-opacity-75">Credit Card
                                                    Number</span>
                                                <h6 class="text-white text-xl fw-semibold mt-1 mb-0">2356 9854 3652 5612
                                                </h6>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="pills-Sell" role="tabpanel"
                                    ...
                                    <div class="mb-20">
                                        <label for="estimatedValueSell"
                                            class="fw-semibold mb-8 text-primary-light">Estimated Purchase Value</label>
                                        <div class="input-group input-group-lg border input-form-light radius-8">
