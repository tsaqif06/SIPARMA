                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center gap-12">
                            <div
                                ...
                                <img src="{{ asset('assets/images/home-six/category-icon1.png') }}" alt=""
                                    class="">
                            </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center gap-12">
                            <div
                                ...
                                <img src="{{ asset('assets/images/home-six/category-icon2.png') }}" alt=""
                                    class="">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center gap-12">
                            <div
                                ...
                                <img src="{{ asset('assets/images/home-six/category-icon3.png') }}" alt=""
                                    class="">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center gap-12">
                            <div
                                ...
                                <img src="{{ asset('assets/images/home-six/category-icon4.png') }}" alt=""
                                    class="">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center gap-12">
                            <div
                                ...
                                <img src="{{ asset('assets/images/home-six/category-icon5.png') }}" alt=""
                                    class="">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-0">
                        <div class="d-flex align-items-center gap-12">
                            <div
                                ...
                                <img src="{{ asset('assets/images/home-six/category-icon6.png') }}" alt=""
                                    class="">
                            </div>
                            <div class="flex-grow-1">
        ...
        <div class="col-xxl-4 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/home-six/student-img1.png') }}" alt=""
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/home-six/student-img2.png') }}" alt=""
                                class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/home-six/student-img3.png') }}" alt=""
                                class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/home-six/student-img4.png') }}" alt=""
                                class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/home-six/student-img5.png') }}" alt=""
                                class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-0">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/home-six/student-img6.png') }}" alt=""
                                class="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden">
                            <div class="flex-grow-1">
