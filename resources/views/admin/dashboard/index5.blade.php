                        ...
                        <div class="me-40">
                            ...
                            <div class="">
                                ...
                                <span class="text-success-main fw-bold d-inline-flex align-items-center gap-1">10%
                                    <iconify-icon icon="iconamoon:arrow-up-2-fill" class="icon"></iconify-icon> </span>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="">
                                ...
                                <span class="text-danger-main fw-bold d-inline-flex align-items-center gap-1">10%
                                    <iconify-icon icon="iconamoon:arrow-down-2-fill" class="icon"></iconify-icon> </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-24">
                        <div class="d-flex align-items-center gap-1 justify-content-between mb-44">
                            ...
                            <div class="position-relative">
                                ...
                                <span
                                    class="w-36-px h-36-px rounded-circle bg-neutral-100 d-flex justify-content-center align-items-center position-absolute start-50 translate-middle top-100">
                ...
                <div class="card-body p-24">
                    ...
                    <div class="d-flex align-items-start gap-2 mb-20">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="text-sm text-secondary-light fw-medium mb-1">Lorem Ipsum is simply dummy text of the
                                printing and typesetting industry. Lorem Ipsum is simply dummy.</p>
                    ...
                    <div class="d-flex align-items-start gap-2">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="text-sm text-secondary-light fw-medium mb-1">Lorem Ipsum is simply dummy text of the
                                printing Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            <span class="text-sm text-secondary-light fw-normal">25 Jan 2024</span>
                        </div>
                    </div>
