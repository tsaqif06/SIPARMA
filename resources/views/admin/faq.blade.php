            ...
            <div class="responsive-padding-40-150 bg-light-pink">
                <div class="row gy-4 align-items-center">
                    <div class="col-xl-7">
                        ...
                        <p class="mb-0 text-secondary-light max-w-634-px text-xl">Lorem Ipsum is simply dummy text of the
                            printing and typesetting industry. Lorem Ipsum has been the industry's standard du text ever
                            since the 1500s, when an unkn</p>
                    </div>
            ...
            <div class="row gy-4">
                <div class="col-lg-4">
                    <div class="active-text-tab nav flex-column nav-pills bg-base shadow py-0 px-24 radius-12 border"
                        ...
                        <button class="nav-link text-secondary-light fw-semibold text-xl px-0 py-16 border-bottom active"
                        ...
                        <button class="nav-link text-secondary-light fw-semibold text-xl px-0 py-16 border-bottom"
                            ...
                            role="tab" aria-controls="v-pills-ux-ui" aria-selected="false">UX UI Design</button>
                        <button class="nav-link text-secondary-light fw-semibold text-xl px-0 py-16 border-bottom"
                        ...
                        <button class="nav-link text-secondary-light fw-semibold text-xl px-0 py-16 border-bottom"
                            ...
                            type="button" role="tab" aria-controls="v-pills-use-case" aria-selected="false">How to can
                            i use WowDash? </button>
                        <button class="nav-link text-secondary-light fw-semibold text-xl px-0 py-16"
                            ...
                            type="button" role="tab" aria-controls="v-pills-use-agency" aria-selected="false">Can I use
                            my agency?</button>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-about-us" role="tabpanel"
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button text-primary-light text-xl collapsed" type="button"
