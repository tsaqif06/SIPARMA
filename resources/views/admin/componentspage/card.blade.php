...
@section('content')
    <div class="mb-40">
        <div class="row gy-4">
                ...
                <div class="card h-100 radius-12">
                    ...
                    <div class="card-body p-16">
                        <h5 class="card-title text-lg text-primary-light
                         mb-6">This is Card title
                        </h5>
                        <p class="card-text text-neutral-600">We quickly learn to fear and thus automatically avo id
                            potentially stressful situations of all kinds, including the most common of all .</p>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <img src="{{ asset('assets/images/card-component/card-img2.png') }}" class="card-img-top"
                        alt="">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <img src="{{ asset('assets/images/card-component/card-img3.png') }}" class="card-img-top"
                        alt="">
                    <div class="card-body p-16 text-end">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-3">
                            <a href="javascript:void(0)"
                                class="btn btn-primary-100 text-white text-primary-600 px-12 py-10 d-inline-flex align-items-center gap-2">
                                Read More <iconify-icon icon="iconamoon:arrow-right-2" class="text-xl"></iconify-icon>
                            </a>
                            <button
                                class="btn btn-warning-100 text-white text-warning-600 px-12 py-10 d-inline-flex align-items-center gap-2">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <img src="{{ asset('assets/images/card-component/card-img4.png') }}" class="card-img-top"
                        alt="">
                    <div class="card-body p-16 text-center">
                        <h5 class="card-title text-lg text-primary-light
                         mb-6">This is Card title
        ...
        <div class="row gy-4">
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <div class="card-body p-24">
                        <div
                            class="w-64-px h-64-px d-inline-flex align-items-center justify-content-center bg-gradient-purple text-lilac-600 mb-16 radius-12">
                            <iconify-icon icon="solar:medal-ribbons-star-bold" class="h5 mb-0"></iconify-icon>
                        </div>
                        <h6 class="mb-8">Brand Identity</h6>
                        <p class="card-text mb-8 text-secondary-light">Random Text gateway to the Origin al the Works
                            Platform, & your unique block chain gateway identity.</p>
                        <a href="javascript:void(0)"
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12 text-center">
                    <div class="card-body p-24">
                        <div
                            class="w-64-px h-64-px d-inline-flex align-items-center justify-content-center bg-gradient-primary text-primary-600 mb-16 radius-12">
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="card h-100 radius-12 p-0 overflow-hidden position-relative">
                    <div class="card-body p-0 gradient-overlay bottom-0 start-0">
                        <img src="{{ asset('assets/images/card-component/card-overlay-img1.png') }}" alt=""
                            class="w-100 h-100">
                        <div class="position-absolute start-0 bottom-0 p-24 z-1">
                            <h5 class="card-title text-white text-primary-light
                             text-lg mb-6">
                                This is Card title</h5>
                            <p class="card-text text-white">We quickly learn to fear and thus automatically avo id
                                potentially stressful situations of all kinds, including the most common of all</p>
                            <a href="javascript:void(0)"
                                class="btn text-primary-600 hover-text-primary px-0 py-10 d-inline-flex align-items-center gap-2">
                                Read More <iconify-icon icon="iconamoon:arrow-right-2" class="text-xl"></iconify-icon>
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="card radius-12 h-100">
                    ...
                    <div class="card-body py-16 px-24">
                        ...
                        <p class="card-text text-neutral-600 mb-0">Intrinsically incubate intuitive opportunities and
                            real-time potentialities for change for interoperable meta-itself
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="card radius-12 h-100">
                    <div class="card-body py-16 px-24">
                        ...
                        <p class="card-text text-neutral-600 mb-16">Intrinsically incubate intuitive opportunities and
                            real-time potentialities for change for interoperable meta-itself the viewer's attention from
                            the layout</p>
                        <p class="card-text text-neutral-600 mb-0">Intrinsically incubate intuitive opportunities and
                            real-time potentialities for change for interoperable </p>
                        <a href="javascript:void(0)"
                            class="btn text-primary-600 hover-text-primary px-0 py-0 d-inline-flex align-items-center gap-2 mt-16">
                            Read More <iconify-icon icon="iconamoon:arrow-right-2" class="text-xl"></iconify-icon>
                        </a>
                    </div>
                </div>
    ...
    <div class="mb-40">
        ...
        <div class="row gy-4">
            <div class="col-xl-6">
                <div class="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row">
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="{{ asset('assets/images/card-component/horizontal-card-img1.png') }}"
                    ...
                    <div class="card-body p-16 flex-grow-1">
                        ...
                        <p class="card-text text-neutral-600 mb-16">We quickly learn to fear and thus automatically avo id
                            potentially stressful situations of all kinds, including the most common of all .</p>
                        <a href="javascript:void(0)"
            ...
            <div class="col-xl-6">
                <div
                    class="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row flex-row-reverse">
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="{{ asset('assets/images/card-component/horizontal-card-img2.png') }}"
                            class="h-100 w-100 object-fit-cover" alt="">
                    </div>
                    <div class="card-body p-16 flex-grow-1">
                        <h5 class="card-title text-lg text-primary-light mb-6">This is Card title</h5>
            ...
            <div class="col-xl-6">
                <div class="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row">
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="{{ asset('assets/images/card-component/horizontal-card-img3.png') }}"
                            class="h-100 w-100 object-fit-cover" alt="">
                    </div>
                    <div class="card-body p-16 flex-grow-1">
                        <h5 class="card-title text-lg text-primary-light mb-6">This is Card title</h5>
            ...
            <div class="col-xl-6">
                <div
                    class="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row flex-row-reverse">
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="{{ asset('assets/images/card-component/horizontal-card-img4.png') }}"
                            class="h-100 w-100 object-fit-cover" alt="">
                    </div>
                    <div class="card-body p-16 flex-grow-1">
                        <h5 class="card-title text-lg text-primary-light mb-6">This is Card title</h5>
