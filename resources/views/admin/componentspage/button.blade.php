            ...
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <button type="button"
                            class="btn btn-link text-secondary-light text-decoration-none radius-8 px-20 py-11">Link</button>
            ...
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <button type="button"
                            class="btn btn-outline-link text-secondary-light text-decoration-none radius-8 px-20 py-11">Link</button>
                        <button type="button"
                            class="btn btn-outline-light-100 text-dark radius-8 px-20 py-11">Light</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-6">
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        <button type="button"
                            class="btn rounded-pill btn-primary-600 radius-8 px-20 py-11">Primary</button>
                        <button type="button"
                            class="btn rounded-pill btn-lilac-600 radius-8 px-20 py-11">Secondary</button>
                        <button type="button"
                            class="btn rounded-pill btn-success-600 radius-8 px-20 py-11">Success</button>
                        <button type="button" class="btn rounded-pill btn-info-600 radius-8 px-20 py-11">Info</button>
                        <button type="button"
                            class="btn rounded-pill btn-warning-600 radius-8 px-20 py-11">Warning</button>
                        <button type="button" class="btn rounded-pill btn-danger-600 radius-8 px-20 py-11">Danger</button>
                        <button type="button"
                            class="btn rounded-pill btn-neutral-900 text-base radius-8 px-20 py-11">Dark</button>
                        <button type="button"
                            class="btn rounded-pill btn-link text-secondary-light text-decoration-none radius-8 px-20 py-11">Link</button>
                        <button type="button"
                            class="btn rounded-pill btn-light-100 text-dark radius-8 px-20 py-11">Light</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-6">
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        <button type="button"
                            class="btn rounded-pill btn-outline-primary-600 radius-8 px-20 py-11">Primary</button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-lilac-600 radius-8 px-20 py-11">Secondary</button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-success-600 radius-8 px-20 py-11">Success</button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-info-600 radius-8 px-20 py-11">Info</button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-warning-600 radius-8 px-20 py-11">Warning</button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-danger-600 radius-8 px-20 py-11">Danger</button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-neutral-900 radius-8 px-20 py-11">Dark</button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-link text-secondary-light text-decoration-none radius-8 px-20 py-11">Link</button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-light-100 text-dark radius-8 px-20 py-11">Light</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-6">
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        <button type="button"
                            class="btn rounded-pill btn-primary-100 text-primary-600 radius-8 px-20 py-11">Primary</button>
                        <button type="button"
                            class="btn rounded-pill btn-lilac-100 text-lilac-600 radius-8 px-20 py-11">Secondary</button>
                        <button type="button"
                            class="btn rounded-pill btn-success-100 text-success-600 radius-8 px-20 py-11">Success</button>
                        <button type="button"
                            class="btn rounded-pill btn-info-100 text-info-600 radius-8 px-20 py-11">Info</button>
                        <button type="button"
                            class="btn rounded-pill btn-warning-100 text-warning-600 radius-8 px-20 py-11">Warning</button>
                        <button type="button"
                            class="btn rounded-pill btn-danger-100 text-danger-600 radius-8 px-20 py-11">Danger</button>
                        <button type="button"
                            class="btn rounded-pill btn-neutral-100 text-primary-light radius-8 px-20 py-11">Dark</button>
                        <button type="button"
                            class="btn rounded-pill btn-link text-secondary-light text-decoration-none radius-8 px-20 py-11">Link</button>
                        <button type="button"
                            class="btn rounded-pill btn-light-50 text-dark radius-8 px-20 py-11">Light</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-6">
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        <button type="button"
                            class="btn rounded-pill text-primary-600 radius-8 px-20 py-11">Primary</button>
                        <button type="button"
                            class="btn rounded-pill text-lilac-600 radius-8 px-20 py-11">Secondary</button>
                        <button type="button"
                            class="btn rounded-pill text-success-600 radius-8 px-20 py-11">Success</button>
                        <button type="button" class="btn rounded-pill text-info-600 radius-8 px-20 py-11">Info</button>
                        <button type="button"
                            class="btn rounded-pill text-warning-600 radius-8 px-20 py-11">Warning</button>
                        <button type="button"
                            class="btn rounded-pill text-danger-600 radius-8 px-20 py-11">Danger</button>
                        <button type="button"
                            class="btn rounded-pill text-primary-light radius-8 px-20 py-11">Dark</button>
                        <button type="button"
                            class="btn rounded-pill text-secondary-light text-decoration-none radius-8 px-20 py-11">Link</button>
                        <button type="button"
                            class="btn rounded-pill text-secondary-light radius-8 px-20 py-11">Light</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <button type="button"
                            ...
                            Right Icon <iconify-icon icon="mingcute:square-arrow-right-line"
                                class="text-xl"></iconify-icon>
                        </button>
                        <button type="button"
                            class="btn btn-outline-success-600 radius-8 px-20 py-11 d-flex align-items-center gap-2">
                            Right Icon <iconify-icon icon="mingcute:square-arrow-right-line"
                                class="text-xl"></iconify-icon>
                        </button>
                        <button type="button"
                            class="btn btn-warning-600 radius-8 p-20 w-60-px h-50-px d-flex align-items-center justify-content-center gap-2">
                            <iconify-icon icon="mingcute:square-arrow-up-line" class="text-xl"></iconify-icon>
                        </button>
                        <button type="button"
                            class="btn btn-outline-info-600 radius-8 p-20 w-60-px h-50-px d-flex align-items-center justify-content-center gap-2">
            ...
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <button type="button"
                            class="btn rounded-pill btn-outline-primary-600 radius-8 px-20 py-11 d-flex align-items-center gap-2">
                            <iconify-icon icon="mingcute:square-arrow-left-line" class="text-xl"></iconify-icon> Left Icon
                        </button>
                        <button type="button"
                            class="btn rounded-pill btn-success-600 radius-8 px-20 py-11 d-flex align-items-center gap-2">
                            Right Icon <iconify-icon icon="mingcute:square-arrow-right-line"
                                class="text-xl"></iconify-icon>
                        </button>
                        <button type="button"
                        ...
                        <button type="button"
                            class="btn rounded-pill btn-warning-600 radius-8 p-20 w-60-px h-50-px d-flex align-items-center justify-content-center gap-2">
                            <iconify-icon icon="mingcute:square-arrow-up-line" class="text-xl"></iconify-icon>
                        </button>
                        <button type="button"
                            class="btn rounded-pill btn-outline-info-600 radius-8 p-20 w-60-px h-50-px d-flex align-items-center justify-content-center gap-2">
                            <iconify-icon icon="mingcute:square-arrow-down-line" class="text-xl"></iconify-icon>
                        </button>
                    </div>
                </div>
            ...
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <button type="button" class="btn btn-warning-600 radius-8 px-14 py-6 text-sm">Small
                            Button</button>
                    </div>
                    <div class="d-flex flex-wrap align-items-center gap-3 mt-16">
                        <button type="button" class="btn btn-primary-100 text-primary-600 radius-8 px-20 py-11"> Large
                            Button</button>
                        <button type="button" class="btn btn-success-100 text-success-600 radius-8 px-16 py-9">Medium
                            Button</button>
                        <button type="button"
                            class="btn btn-warning-100 text-warning-600 radius-8 px-14 py-6 text-sm">Small Button</button>
                    </div>
                </div>
            </div>
        </div>
