                ...
                <div class="card-body p-24">
                    <div class="d-flex align-items-center flex-wrap gap-28">
                        <div class="form-check checked-primary d-flex align-items-center gap-2">
                            ...
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio1">
                                Radio Active </label>
                        </div>
                        <div class="form-check checked-secondary d-flex align-items-center gap-2">
                            ...
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio2">
                                Radio Active </label>
                        </div>
                        <div class="form-check checked-success d-flex align-items-center gap-2">
                            ...
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio3">
                                Radio Active </label>
                        </div>
                        <div class="form-check checked-warning d-flex align-items-center gap-2">
                            ...
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio4">
                                Radio Active </label>
                        </div>
                    </div>
                    <div class="d-flex align-items-center flex-wrap gap-28 mt-24">
                        <div class="form-check checked-primary d-flex align-items-center gap-2">
                            ...
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio11">
                                Radio Inactive </label>
                        </div>
                        <div class="form-check checked-secondary d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio" id="radio22">
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio22">
                                Radio Inactive </label>
                        </div>
                        <div class="form-check checked-success d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio" id="radio33">
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio33">
                                Radio Inactive </label>
                        </div>
                        <div class="form-check checked-warning d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio" id="radio44">
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio44">
                                Radio Inactive </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-24">
                    <div class="d-flex align-items-center flex-wrap gap-28">
                        <div class="form-check checked-primary d-flex align-items-center gap-2">
                            ...
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio111">
                                Radio Active </label>
                        </div>
                        <div class="form-check checked-secondary d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio22" id="radio222" checked disabled>
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio222">
                                Radio Active </label>
                        </div>
                        <div class="form-check checked-success d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio33" id="radio333" checked disabled>
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio333">
                                Radio Active </label>
                        </div>
                        <div class="form-check checked-warning d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio44" id="radio444" checked disabled>
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio444">
                                Radio Active </label>
                        </div>
                    </div>
                    <div class="d-flex align-items-center flex-wrap gap-28 mt-24">
                        <div class="form-check checked-primary d-flex align-items-center gap-2">
                            ...
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio1011">
                                Radio Inactive </label>
                        </div>
                        <div class="form-check checked-secondary d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio0" id="radio2022" disabled>
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio2022">
                                Radio Inactive </label>
                        </div>
                        <div class="form-check checked-success d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio0" id="radio3033" disabled>
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio3033">
                                Radio Inactive </label>
                        </div>
                        <div class="form-check checked-warning d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="radio0" id="radio4044" disabled>
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="radio4044">
                                Radio Inactive </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-24">
                    <div class="d-flex align-items-start flex-column flex-wrap gap-3">
                        <div class="form-check checked-primary d-flex align-items-center gap-2">
                            ...
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="vertical11">
                                Vertical 1 </label>
                        </div>
                        <div class="form-check checked-secondary d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="vertical" id="vertical22">
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="vertical22">
                                Vertical 2 </label>
                        </div>
                        <div class="form-check checked-success d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="vertical" id="vertical33">
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="vertical33">
                                Vertical 3 </label>
                        </div>
                        <div class="form-check checked-warning d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio" name="vertical" id="vertical44">
                            <label class="form-check-label line-height-1 fw-medium text-secondary-light" for="vertical44">
                                Vertical 4 </label>
                        </div>
                    </div>
                </div>
