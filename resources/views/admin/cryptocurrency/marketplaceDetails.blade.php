                ...
                <div class="card-body px-24 py-32">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-24">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/images/crypto/bitcoin.png') }}" alt=""
                                class="w-72-px h-72-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                            <div class="flex-grow-1 d-flex flex-column">
                                <h4 class="mb-4">Bitcoin <span class="text-md text-neutral-400 fw-semibold">BTC</span>
                                </h4>
                                <span class="text-md mb-0 fw-medium text-neutral-500 d-block">Currency in USD. Market
                                    Open</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-24">
                            ...
                            <button type="button"
                                class="star-btn w-48-px h-48-px d-flex justify-content-center align-items-center border radius-8 text-2xl text-neutral-400 text-hover-primary-600 line-height-1">
                    ...
                    <p class="text-secondary-light">IoT Chain (ITC) is a cryptocurrency and operates on the Ethereum
                        platform. IoT Chain has a current supply of 99,999,999 with 87,214,657.4756 in circulation. The last
                        known price of IoT Chain is 0.01318397 USD and is up 0.00 over the last 24 hours. It is currently
                        trading on 5 active market(s) with $0.00 traded over the last 24 hours. More information can be
                        found at https://iotchain.io/.</p>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span
                                                class="bg-success-focus text-success-600 px-16 py-6 rounded-pill fw-semibold text-xs">
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex align-items-center gap-8 w-100-px">
                                                <div class="progress w-100  bg-primary-50 rounded-pill h-4-px"
            ...
            <div class="card h-100">
                <div class="card-body p-0">
                    <div class="p-24 border-bottom">
                        <ul class="nav nav-pills style-three pill-tab border input-form-light p-0 radius-8 bg-neutral-50"
                            id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link px-12 py-10 text-md w-100 text-center radius-8 active"
                                    id="pills-Buy-tab" data-bs-toggle="pill" data-bs-target="#pills-Buy" type="button"
                                    role="tab" aria-controls="pills-Buy" aria-selected="true">Buy</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link px-12 py-10 text-md w-100 text-center radius-8" id="pills-Sell-tab"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link px-12 py-10 text-md w-100 text-center radius-8"
                                    id="pills-Convert-tab" data-bs-toggle="pill" data-bs-target="#pills-Convert"
                                    type="button" role="tab" aria-controls="pills-Convert"
                                    aria-selected="false">Convert</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-Buy" role="tabpanel"
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-24 border radius-8 position-relative">
                                        <button type="button"
                                            class="bg-primary-600 w-40-px h-40-px rounded-circle border border-3 border-primary-100 d-flex justify-content-center align-items-center text-white position-absolute top-50 translate-middle-y end-0 me-60">
                                        ...
                                        <div class="p-16 d-flex align-items-center border-bottom">
                                            ...
                                            <div
                                                class="d-flex align-items-center justify-content-between flex-grow-1 ps-16">
                                                <div class="d-flex align-items-center gap-8">
                                                    <img src="{{ asset('assets/images/crypto/crypto-img1.png') }}"
                                                        alt=""
                                                        class="w-24-px h-24-px rounded-circle flex-shrink-0 overflow-hidden">
                                                    <div class="flex-grow-1 d-flex flex-column">
                                                        <span
                                                            class="text-sm mb-0 fw-medium text-primary-light d-block">ITC</span>
                                                    </div>
                                                </div>
                                                <a href=""
                                                    class="text-md text-neutral-500 text-hover-primary-600"><i
                                        ...
                                        <div class="p-16 d-flex align-items-center">
                                            ...
                                            <div
                                                class="d-flex align-items-center justify-content-between flex-grow-1 ps-16">
                                                <div class="d-flex align-items-center gap-8">
                                                    <img src="{{ asset('assets/images/crypto/paypal.png') }}"
                                                        alt=""
                                                        class="w-24-px h-24-px rounded-circle flex-shrink-0 overflow-hidden">
                                                    <div class="flex-grow-1 d-flex flex-column">
                                                        <span
                                                            class="text-sm mb-0 fw-medium text-primary-light d-block">Paypal</span>
                                                    </div>
                                                </div>
                                                <a href=""
                                                    class="text-md text-neutral-500 text-hover-primary-600"><i
                                    ...
                                    <button type="button"
                                        class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-8 mt-24 pb-8"
                            ...
                            <div class="tab-pane fade" id="pills-Convert" role="tabpanel"
                                aria-labelledby="pills-Convert-tab" tabindex="0">
                                <div class="">
                                    <div class="text-center mt-24">
                                        <h3 class="text-neutral-400 mb-16">$0</h3>
                                        <span class="text-neutral-500 text-sm">You can buy up to $25,000</span>
            ...
            <div class="modal-content radius-16 bg-base">
                <div class="modal-body px-32 py-56">
                    <div class="text-center">
                        <span
                            class="w-100-px h-100-px bg-success-600 rounded-circle d-inline-flex justify-content-center align-items-center text-2xxl mb-32 text-white">
                            <i class="ri-check-line"></i>
                        </span>
                        <h5 class="mb-8 text-2xl">Your purchase was successful!</h5>
                        <p class="text-neutral-500 mb-0"> <span class="text-primary-600">16.2665 ITC</span> will be
