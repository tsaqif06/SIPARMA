    ...
    <div class="card h-100 p-0 radius-12">
        <div
            ...
            <div class="d-flex align-items-center flex-wrap gap-3">
                ...
                <button type="button"
                    class="btn border py-8 text-secondary-light fw-medium bg-hover-neutral-50 radius-8">Watchlist</button>
            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button"
                                    class="star-btn text-2xl text-neutral-400 text-hover-primary-600 line-height-1"><i
