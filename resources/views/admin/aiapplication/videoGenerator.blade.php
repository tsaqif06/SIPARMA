            ...
            <div class="card h-100 p-0">
                <div class="card-body p-24">
                    <div class="mb-20">
                        ...
                        <input type="text" class="form-control px-16 py-14 h-48-px" id="Title"
                ...
                <div class="chat-message-list max-h-612-px min-h-612-px">
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-start gap-16">
                            ...
                            <div class="info">
                                ...
                                <p class="mb-0 text-secondary-light text-sm">Alright guys, so I've just seen this website,
                                    Fortunanest website, it's an investment website and you invest there. So I actually
                                    tried it some months, I tried it just for 3 months and I realized everything was working
                                    correct. I was thinking it was this fake website, I never met this website.</p>
                            </div>
                        </div>
                        <button type="button"
                    ...
                    <div class="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                        ...
                        <div class="info flex-grow-1">
                            ...
                            <div class="row g-3">
                                <div class="col-xl-4 col-sm-6">
                                    <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                        <img src="{{ asset('assets/images/chatgpt/image-generator5.png') }}" alt=""
                                            class="w-100 h-100 object-fit-cover">
                                        <button
                                            class="w-72-px h-72-px bg-primary-600 rounded-circle text-white text-2xxl d-flex align-items-center justify-content-center bg-hover-primary-700 position-absolute top-50 start-50 translate-middle">
                            ...
                            <button type="button"
                                class="btn btn-primary d-flex align-items-center gap-8 px-20 flex-shrink-0 mt-16">
                                Download
