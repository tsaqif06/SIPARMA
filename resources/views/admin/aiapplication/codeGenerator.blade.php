                    ...
                    <ul class="ai-chat-list scroll-sm pe-24 ps-24 pb-24">
                        ...
                        <li class="mb-16">
                            <a href="{{ route('codeGenerator') }}"
                                class="text-line-1 text-secondary-light text-hover-primary-600">Please create a 5 Column
                                table with HTML Css and js </a>
                        </li>
                        <li class="mb-16">
                            <a href="{{ route('codeGenerator') }}"
            ...
            <div class="chat-main card overflow-hidden">
                <div class="chat-sidebar-single gap-8 justify-content-between cursor-default flex-nowrap">
                    <div class="d-flex align-items-center gap-16">
                        <a href="{{ route('codeGeneratorNew') }}" class="text-primary-light text-2xl line-height-1"><i
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-center gap-16">
                            ...
                            <div class="info flex-grow-1">
                                ...
                                <p class="mb-0 text-secondary-light text-sm">Please create a 5 Column table with HTML Css
                                    and js </p>
                            </div>
                        </div>
                        <button type="button"
