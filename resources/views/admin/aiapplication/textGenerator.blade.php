                    ...
                    <ul class="ai-chat-list scroll-sm pe-24 ps-24 pb-24">
                        ...
                        <li class="mb-16">
                            <a href="{{ route('textGenerator') }}"
                                class="text-line-1 text-secondary-light text-hover-primary-600">UI/UX Design Roadmap write
                                me the roadmap right now </a>
                        </li>
                        <li class="mb-16">
                            <a href="{{ route('textGenerator') }}"
                                class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs,
                                healthy</a>
                        </li>
                        <li class="mb-16">
                            <a href="{{ route('textGenerator') }}"
                        ...
                        <li class="mb-16">
                            <a href="{{ route('textGenerator') }}"
                                class="text-line-1 text-secondary-light text-hover-primary-600">Online School Education
                                Learning</a>
                        </li>
                        <li class="mb-16">
                            <a href="{{ route('textGenerator') }}"
                        ...
                        <li class="mb-0">
                            <a href="" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense
                ...
                <div class="chat-message-list max-h-612-px min-h-612-px">
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-center gap-16">
                            ...
                            <div class="info flex-grow-1">
                                ...
                                <p class="mb-0 text-secondary-light text-sm">UI/UX Design Roadmap write me the roadmap right
                                    now </p>
                            </div>
                        </div>
                        <button type="button"
                    ...
                    <div class="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                        ...
                        <div class="info flex-grow-1">
                            ...
                            <p class="mb-16 text-secondary-light text-sm">Creating a UI/UX Design roadmap involves several
                                key stages, from initial research to final testing and iteration. Here’s a detailed roadmap
                                that outlines the typical steps and best practices in a UI/UX design project:</p>
                            ...
                            <ul class="list-style">
                                <li class="text-primary-light m-0"> <span class="fw-semibold text-primary-light">Kickoff
                                        Meeting:</span> Meet with stakeholders to understand the business objectives, target
                                    audience, and project scope.</li>
                                <li class="text-primary-light m-0"> <span class="fw-semibold text-primary-light">Kickoff
                                        Meeting:</span> Meet with stakeholders to understand the business objectives, target
                                    audience, and project scope.</li>
                            </ul>
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-center gap-16">
                            ...
                            <div class="info flex-grow-1">
                                <h6 class="text-lg mb-4">Adam Milner</h6>
                                <p class="mb-0 text-secondary-light text-sm">UI/UX Design Roadmap write me the roadmap
                                    right now </p>
                            </div>
                        </div>
                        <button type="button"
