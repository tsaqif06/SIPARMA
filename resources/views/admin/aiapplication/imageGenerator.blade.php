...
@php
    ...
    $script = '<script>
        $(".generated-image-item .form-check-input").on("click", function() {
            $(this).parent().parent(".generated-image-item").toggleClass(
                "border border-primary-600 border-width-2-px")
        });
    </script>';
@endphp
        ...
        <div class="col-xxl-3 col-lg-4">
            <div class="card h-100 p-0">
                <div class="card-body p-24">
                    ...
                    <div class="mb-20">
                        <label for="LightingStyle" class="text-sm fw-semibold text-primary-light mb-8">Lighting
                            Style</label>
            ...
            <div class="chat-main card overflow-hidden">
                <div class="chat-sidebar-single gap-8 justify-content-between cursor-default flex-nowrap">
                    <div class="d-flex align-items-center gap-16">
                        <a href="{{ route('textGeneratorNew') }}" class="text-primary-light text-2xl line-height-1"><i
                                class="ri-arrow-left-line"></i></a>
                        <h6 class="text-lg mb-0 text-line-1">Please, Make 4 variant of this image Quickly As Soon As
                            possible</h6>
                    </div>
                ...
                <div class="chat-message-list max-h-612-px min-h-612-px">
                    ...
                    <div
                        class="d-flex align-items-start justify-content-between gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                        <div class="d-flex align-items-center gap-16">
                            ...
                            <div class="info">
                                ...
                                <p class="mb-0 text-secondary-light text-sm">Please, Make 4 variant of this image Quickly As
                                    Soon As possible </p>
                            </div>
                        </div>
                        <button type="button"
                    ...
                    <div class="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                        <div class="img overflow-hidden flex-shrink-0">
                            <img src="{{ asset('assets/images/wow-dash-favicon.png') }}" alt="image"
                                class="w-44-px h-44-px rounded-circle object-fit-cover">
                        </div>
                        <div class="info flex-grow-1">
                            ...
                            <div class="row g-3">
                                <div class="col-xl-3 col-sm-6">
                                    <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                        <img src="{{ asset('assets/images/chatgpt/image-generator1.png') }}" alt=""
                                        ...
                                        <div
                                            ...
                                            <input class="form-check-input radius-4 border border-neutral-400"
                                                id="image1" type="checkbox" name="checkbox">
                                        </div>
                                ...
                                <div class="col-xl-3 col-sm-6">
                                    <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                        <img src="{{ asset('assets/images/chatgpt/image-generator2.png') }}"
                                            alt="" class="w-100 h-100 object-fit-cover">
                                        <div
                                            class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
                                            <input class="form-check-input radius-4 border border-neutral-400"
                                                id="image2" type="checkbox" name="checkbox">
                                        </div>
                                ...
                                <div class="col-xl-3 col-sm-6">
                                    <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                        <img src="{{ asset('assets/images/chatgpt/image-generator3.png') }}"
                                            alt="" class="w-100 h-100 object-fit-cover">
                                        <div
                                            class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
                                            <input class="form-check-input radius-4 border border-neutral-400"
                                                id="image3" type="checkbox" name="checkbox">
                                        </div>
                                ...
                                <div class="col-xl-3 col-sm-6">
                                    <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                        <img src="{{ asset('assets/images/chatgpt/image-generator4.png') }}"
                                            alt="" class="w-100 h-100 object-fit-cover">
                                        <div
                                            class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
                                            <input class="form-check-input radius-4 border border-neutral-400"
                                                id="image4" type="checkbox" name="checkbox">
                                        </div>
                            ...
                            <div class="mt-24 d-flex align-items-center justify-content-between gap-16">
                                <div
                                    class="d-flex align-items-center gap-20 bg-neutral-50 radius-8 px-16 py-10 line-height-1">
                                    <button type="button"
                                        class="text-secondary-light text-2xl d-flex text-hover-info-600"><i
                                ...
                                <button type="button" class="btn btn-outline-primary d-flex align-items-center gap-8"> <i
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-center gap-16">
                            ...
                            <div class="info">
                                <h6 class="text-lg mb-4">Adam Milner</h6>
                                <p class="mb-0 text-secondary-light text-sm">Please, Make 4 variant of this image Quickly
                    ...
                    <div class="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                        ...
                        <div class="info flex-grow-1">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                        <img src="{{ asset('assets/images/chatgpt/image-generator5.png') }}"
                                            alt="" class="w-100 h-100 object-fit-cover">
                                        <button type="button"
                                            class="download-btn position-absolute top-0 end-0 me-8 mt-8 w-50-px h-50-px bg-primary-600 text-white d-flex justify-content-center align-items-center radius-6 text-2xl bg-hover-primary-700">
