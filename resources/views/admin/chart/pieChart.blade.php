    ...
    <div class="row gy-4">
            ...
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24 text-center d-flex flex-wrap align-items-start gap-5 justify-content-center">
                    ...
                    <div class="max-w-290-px w-100">
                        <div
                            class="d-flex align-items-center justify-content-between gap-12 border pb-12 mb-12 border-end-0 border-top-0 border-start-0">
        ...
        <div class="col-md-6">
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24 text-center">
                    <div id="radarChart" class="square-marker check-marker series-gap-24 d-flex justify-content-center">
                    </div>
                </div>
            </div>
        </div>
