                ...
                <div class="card">
                    ...
                    <div class="card-body p-24">
                        <form class="position-relative">
                            <input type="text" class="form-control border border-neutral-200 radius-8 ps-40"
                    ...
                    <div class="card-body d-flex flex-column gap-24 p-24">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="blog__content">
                                <h6 class="mb-8">
                                    <a href="{{ route('blogDetails') }}"
                                        class="text-line-2 text-hover-primary-600 text-md transition-2">The Future of
                    ...
                    <div class="card-body p-24">
                        <ul>
                            <li
                                ...
                                <a href="{{ route('blog') }}" class="text-hover-primary-600 transition-2"> Techbology
                                </a>
                                <span
                            ...
                            <li
                                class="w-100 d-flex align-items-center justify-content-between flex-wrap gap-8 border-bottom border-dashed pb-12 mb-12">
                                <a href="{{ route('blog') }}" class="text-hover-primary-600 transition-2"> Consulting
                                </a>
                                <span
                                    class="text-neutral-500 w-28-px h-28-px rounded-circle bg-neutral-100 d-flex justify-content-center align-items-center transition-2 text-xs fw-semibold">
                                    01 </span>
                            ...
                            <li class="w-100 d-flex align-items-center justify-content-between flex-wrap gap-8">
                                <a href="{{ route('blog') }}" class="text-hover-primary-600 transition-2"> Real Estate
                                </a>
                                <span
                                    class="text-neutral-500 w-28-px h-28-px rounded-circle bg-neutral-100 d-flex justify-content-center align-items-center transition-2 text-xs fw-semibold">
                                    01 </span>
