    ...
    <section class="verifikasi-section section-padding" style="margin-top: -150px">
        <div class="container mt-5 d-flex">
            ...
            <div class="row">
                ...
                <!-- Konten Wisata -->
                <div class="container-form flex-grow-1 col-md-9 col-12">
                    <div class="dropdown">
                        <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton1"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            Urutkan : {{ request('sort', 'Paling Populer') }}
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item"
                                    ...
                                    Terendah</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('destination.browse', array_merge(request()->all(), ['sort' => 'ulasan_tertinggi'])) }}">Ulasan
                                    Tertinggi</a></li>
                        </ul>
                    </div>
